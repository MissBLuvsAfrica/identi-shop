    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${CONTACT_INFO.email}`} className="text-gray-600 hover:text-black">
                  {CONTACT_INFO.email}
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${CONTACT_INFO.phone}`} className="text-gray-600 hover:text-black">
                  {CONTACT_INFO.phone}
                </a>
              </div>
            </div>
        ...
        <div className="bg-green-50 p-8 flex flex-col items-center justify-center text-center">
          <svg className="w-16 h-16 text-green-500 mb-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h2 className="text-xl font-medium mb-4">CHAT WITH US</h2>
          <p className="text-gray-600 mb-6">
            For the fastest response, reach out to us on WhatsApp. 
            We typically respond within minutes during business hours.
          </p>
          <a
            href={`https://wa.me/${process.env.WHATSAPP_E164 || '254700000000'}?text=Hi! I have a question about ${SITE_NAME}.`}
            target="_blank"
            rel="noopener noreferrer"
