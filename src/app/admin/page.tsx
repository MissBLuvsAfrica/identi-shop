...
import { getAllOrders, getAllProducts } from '@/lib/sheets';
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Link
          ...
          className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow"
        >
          <h2 className="text-lg font-medium mb-2">Manage Orders</h2>
          <p className="text-gray-600">View orders and update status</p>
        </Link>
      </div>
